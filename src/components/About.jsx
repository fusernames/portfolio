    ...
    <CommandLine text="about me">
      <div>
        ...
        <Typography variant="h6" align="left">
          My name is <b style={{ color: theme.palette.secondary.main }}>Alexis</b>, I'm french, I'm 24 years old.<br/>I'm student at 42 school Paris and looking for a job in the US.
        </Typography>
        <Typography style={{ marginTop: 24 }} align="left">
          ...
          Now I would like to contribute my skills and experiences in a new team. My goal is to join a company in the US to work and keep learning about everything concerning tech.<br/>
        </Typography>
